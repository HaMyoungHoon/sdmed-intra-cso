...
export class CustomPickListComponent implements AfterContentInit, OnChanges {
  ...
  @Output() onSourceFilter: EventEmitter<FilterModel> = new EventEmitter();
  @Output() onTargetFilter: EventEmitter<FilterModel> = new EventEmitter();
  @Input() sourceList: any[] = [];
  @Input() targetList: any[] = [];
  @Input() selectedSource: any;
  @Output() selectedSourceChange: EventEmitter<any> = new EventEmitter();
  @Input() selectedTarget: any;
  @Output() selectedTargetChange: EventEmitter<any> = new EventEmitter();
  ...
  draggedSource?: any;
  draggedTarget?: any;
  @Output() sourceDropChange: EventEmitter<any> = new EventEmitter();
  @Output() targetDropChange: EventEmitter<any> = new EventEmitter();
  @Output() sourceDragChange: EventEmitter<any> = new EventEmitter();
  @Output() targetDragChange: EventEmitter<any> = new EventEmitter();
  @Output() sourceSelectChange: EventEmitter<any> = new EventEmitter();
  @Output() targetSelectChange: EventEmitter<any> = new EventEmitter();
