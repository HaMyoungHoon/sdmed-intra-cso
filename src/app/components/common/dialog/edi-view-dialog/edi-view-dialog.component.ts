...
@Component({
  ...
  imports: [Accordion, AccordionContent, AccordionHeader, AccordionPanel, Button, FormsModule, FullscreenFileViewComponent, GalleriaModule, NgForOf, NgIf, ProgressSpinComponent, TableModule, Tag, TranslatePipe, Textarea, IftaLabel, InputText, ImageModifyViewComponent, EdiPharmaFileViewModelComponent
  ],
